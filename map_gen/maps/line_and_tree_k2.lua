...
local imersite_shape = b.throttle_world_xy(b.circle(9), 1, 15, 1, 15)
...
local ores = {
  ...
  {b.resource(oil_shape, 'crude-oil', value(120000, 50, 1.15)), 6},
	{b.resource(ore_shape, 'rare-metals', value(300, 0.3, 1.05)), 6},
	{b.resource(imersite_shape, 'imersite', value(120000, 50, 1.15)), 6},
	{b.resource(oil_shape, 'mineral-water', value(120000, 50, 1.15)), 6}
    --{b.empty_shape, 52}
}
